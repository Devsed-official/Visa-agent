...
export type LiveWaveformProps = HTMLAttributes<HTMLDivElement> & {
  ...
  deviceId?: string
  /**
   * External MediaStream to visualize (e.g., from LiveKit).
   * When provided, the component won't create its own microphone stream.
   */
...
export const LiveWaveform = ({
  ...
  useEffect(() => {
    if (!active) {
      // Only stop tracks if we created them (not external stream)
