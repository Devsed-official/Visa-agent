...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "border-input bg-white h-12 w-full min-w-0 rounded-[0.78rem] border pl-4 pr-3 text-base md:text-sm transition-[color,box-shadow] outline-none",
        "flex items-center justify-between gap-2 whitespace-nowrap disabled:cursor-not-allowed disabled:opacity-50",
        "data-[placeholder]:text-muted-foreground [&_svg:not([class*='text-'])]:text-muted-foreground",
        "focus-visible:border-[#4897e5] focus-visible:ring-[#177EE8]/20 focus-visible:ring-[3px]",
